...
import com.arjinmc.jetpackplayground.databinding.ActConstrainLayoutBarrierBinding
 ...
 */
class ConstrainLayoutBarrierActivity : BasicActivity() {

    private val binding by viewBinding(ActConstrainLayoutBarrierBinding::inflate)
    ...
    override fun initData() {
        ...
        setTitle(R.string.constrain_layout_barrier)
    }
